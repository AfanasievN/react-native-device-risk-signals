...
| `sdks/ios/` | In development | Standalone iOS Swift Package with optional Mac Catalyst support; currently the shared statistics helper, runtime timing, numeric consistency, locale, application metadata and telephony |
